...
#' @param option indicates which table to display : *0* (row percentages), *1* (residuals and Chi2 contributions) or *2* (row percentages including some contingency analysis results)
...
#' @importFrom questionr cramer.v lprop
...
actab <- function (data,var1,var2,option,palette,
  ...
  # colonnes constituant le corps du tableau + V de Crame
